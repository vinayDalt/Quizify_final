package com.stackroute.quizify.recommendationservice.config;
...
public class SwaggerConfiguration implements WebMvcConfigurer
{
    ...
    public Docket apiDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.stackroute.quizify.recommendationservice.controller"))
